...
function mission(){
    ...
    return (
        ...
        <Head>
            <title>Foxsocial - Mission </title>
            <meta name="description" content="meta description for content mission page here"/>
        </Head>
        ...
        <h2 className="page-title font-AlegreyaSans">Mission</h2>
