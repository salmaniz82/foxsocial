...
function privacyPolicy(){
    ...
    return (
        ...
        <Head>
            <title>Foxsocial - Privacy </title>
            <meta name="description" content="meta description for content Privacy Policy page here"/>
        </Head>
        ...
        <h2 className="page-title font-AlegreyaSans">Privacy Policy</h2>
