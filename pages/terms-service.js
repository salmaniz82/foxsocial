...
function privacyPolicy(){
    ...
    return (
        ...
        <Head>
            <title>Foxsocial - Terms of services </title>
            <meta name="description" content="meta description for content Terms of services page here"/>
        </Head>
        ...
        <h2 className="page-title font-AlegreyaSans">Terms of Services</h2>
